...
ActiveRecord::Schema[8.1].define(version: 2026_09_08_090100) do
  ...
  create_table "alchemy_elements", force: :cascade do |t|
    ...
    t.index ["parent_element_id"], name: "index_alchemy_elements_on_page_id_and_parent_element_id"
    t.index ["position"], name: "index_elements_on_page_id_and_position"
